...
```shell
es_normalizer --rawfile /home/josevnz/tutorials/docs/EmpireStateRunUp/test/data.txt /home/josevnz/tutorials/docs/EmpireStateRunUp/empirestaterunup/results.csv
```
