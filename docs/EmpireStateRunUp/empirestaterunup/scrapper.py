...
RENDERED_PAGE_JAVASCRIPT = "return document.getElementsByTagName('html')[0].innerHTML;"  # It is important
...
class EmpireStateScrapper:
    ...
    def __init__(self, headless: bool = True, load_wait: int = 5):
        ...
        self.html = self.driver.execute_script(RENDERED_PAGE_JAVASCRIPT)
        self.links = {}
    ...
    def get_race_links(self):
        ...
        for a in self.driver.find_elements(By.TAG_NAME, "a"):
            ...
            if re.search('Bib', href):
                self.links[a.text.strip()] = href.strip()
        return self.links
