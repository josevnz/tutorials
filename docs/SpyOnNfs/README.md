...
Sysdig instruments your physical and virtual machines at the OS level by installing into the Linux kernel and capturing system calls and other OS events. Sysdig uses [DTrace](https://en.wikipedia.org/wiki/DTrace) to get access to the system kernel.
